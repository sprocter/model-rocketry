...
class MMC5983MA:
    ...
    def _calculate_offsets(self) -> None:
        """Calculate the device's offsets and store them
    ...
    def initialize(self) -> None:
        ...
        time.sleep_ms(20) # Datasheet says power on time is 10ms, we'll give a little extra
    ...
    def decode_reading(self, reading: bytearray) -> tuple[float, float, float]:
        ...
        x_adj = x_raw - self._x_offset
        y_adj = y_raw - self._y_offset
        z_adj = z_raw - self._z_offset
